...
import { Mail, Send, Copy, Check, MessageSquare, MapPin, Sparkles } from 'lucide-react';
...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative py-24 z-10 border-t border-slate-900 bg-slate-950/60">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col space-y-2 mb-12">
          ...
          <p className="text-sm text-slate-400 max-w-xl">
            Whether you have a role opportunity, engineering project, or technical inquiry, my inbox is always open.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-5 subtle-glow-box rounded-3xl p-6 sm:p-8 space-y-6"
          >
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-center space-x-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 flex items-center justify-center space-x-2 py-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white transition-all text-xs font-medium"
                >
          ...
          <motion.div
            ...
            className="lg:col-span-7 subtle-glow-box rounded-3xl p-6 sm:p-8"
          >
            {submitted ? (
              <div className="flex flex-col items-center justify-center text-center py-12 space-y-4">
                ...
                <h3 className="text-xl font-bold text-slate-100">Message Transmitted!</h3>
